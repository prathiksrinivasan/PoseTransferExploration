...
def resize_annotations(name, new_name, new_size = (128, 64), old_size = (599, 449), crop_bord=40):
...
root_dir = 'C:/Users/prath/CSStuff/Image Processing/posetransfer/Pose-Transfer/market_data/'
resize_dataset(root_dir + '/test', root_dir + 'fashion_resize/test')
resize_annotations(root_dir + 'market-annotation-test.csv', root_dir + 'market-resize-annotation-test.csv')
