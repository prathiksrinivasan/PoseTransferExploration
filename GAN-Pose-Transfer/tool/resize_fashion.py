...
root_dir = 'C:/Users/prath/CSStuff/Image Processing/posetransfer/Pose-Transfer/fashion_data/'
resize_dataset(root_dir + '/test', root_dir + 'fashion_resize/test')
resize_annotations(root_dir + 'fashion-annotation-test.csv', root_dir + 'fashion-resize-annotation-test.csv')
